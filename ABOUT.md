...
- The specification is versioned as a working master. The current version is **v1.0** (generated 2026-07-08 from the EIOS Framework working draft, with inherited sections incorporated at fork).
